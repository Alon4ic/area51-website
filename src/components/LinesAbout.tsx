...
export default function LinesAbout() {
  return (
      <>
          <>
              <div className="absolute inset-y-0 desktop:left-[80%] lg:left-[87%] left-[90%] w-0.5 bg-gray-500/60">
              ...
              <div className="absolute inset-x-0 desktop:top-[85%] xl:top-[90%] top-[85%] h-0.5 bg-gray-500/60">
